  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 16, color: theme.colors.accentBlue, fontWeight: "700" }}>‹ Back</Text>
        </TouchableOpacity>
        <Text
          style={{
            flex: 1,
      ...
      <FlatList
        data={withInlineBanner(biology, 4)}
        ...
        renderItem={({ item: topic }) => (
          ...
          >
              ...
              {(() => {
                ...
                return (
                  <Text style={{ fontSize: 12, color: theme.colors.textMuted, marginTop: 4 }}>
                    ...
                    {ready > 0 ? (
                      <Text style={{ color: theme.colors.accentBlue, fontWeight: "700" }}> · {ready} ready ▸</Text>
                    ) : (
                      " · coming soon"
                    )}
                  </Text>
            ...
            <Text style={{ fontSize: 20, color: theme.colors.accentBlue }}>›</Text>
          </TouchableOpacity>
          )
        )}
      />
